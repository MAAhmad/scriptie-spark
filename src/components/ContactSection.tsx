      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          duration: 0.6
            ...
            <Card className="p-8 bg-card border-border shadow-medium">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                })} required rows={6} className="bg-background border-border resize-none" placeholder="E.g., stuck on methodology, need help with SPSS analysis, struggling with literature review..." />
                </div>

                <Button type="submit" size="lg" className="w-full bg-gradient-primary hover:opacity-90 text-primary-foreground shadow-medium">
                  Schedule Free Call
                </Button>
              </form>
            </Card>
          ...
          delay: 0.2
            ...
            <Card className="p-6 bg-gradient-primary text-primary-foreground border-0 shadow-medium py-[22px]">
