...
export const HeroSection = () => {
  ...
  return <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-hero">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          ease: "easeOut"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" onClick={scrollToContact} className="bg-gradient-primary hover:opacity-90 text-primary-foreground shadow-medium text-base font-semibold group px-8">
                Request Free Consultation
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground text-base font-semibold">
                View Services
              </Button>
            </div>
          ...
          delay: 0.2
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-strong">
              <img src={heroImage} alt="Graduate student celebrating success" className="w-full h-auto object-cover" />
